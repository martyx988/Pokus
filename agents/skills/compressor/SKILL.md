...
description: "This skill should be used when the user asks to 'compress markdown'. Covers lossless structural optimization and lossy semantic compression with section-by-section analysis."
---
